            ...
            <div class="card-body">
                <form action="{{ route('berita.prosesUbah') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        @enderror
                        <p></p>
                        <img id="tampilFoto" onerror="this.onerror=null;this.src='https://st3.depositphotos.com/23594922/31822/v/1600/depositphotos_318221368-stock-illustration-missing-picture-page-for-website.jpg';" src="{{route('storage',$berita->gambar_berita)}}" alt="" width="15%">
                    </div>
                    <div class="mb-3">
