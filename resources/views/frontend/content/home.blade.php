                        ...
                        <div class="d-flex h-100 align-items-center justify-content-center">
                            <div class="text-center">
                                ...
                                <p class="text-muted mb-4">
                                    ...
                                    <br />
                                    <a href="mailto:elexi.violletta.z@mail.ukrim.ac.id?subject=Pertanyaan%20Terkait%20Berita" target="_blank" rel="noopener noreferrer">elexi.violletta.z@mail.ukrim.ac.id</a>
                                </p>

                                <div class="h6 fw-bolder">Follow us</div>
                                <a class="fs-5 px-2 link-dark" href="https://x.com/Elelelexy?t=elMQq7qfUxOXz3yD6K8lQg&s=08"><i class="bi-twitter"></i></a>
                                <a class="fs-5 px-2 link-dark" href="https://www.facebook.com/elexy.zid"><i class="bi-facebook"></i></a>
                                <a class="fs-5 px-2 link-dark" href="https://www.instagram.com/elexivz/?igsh=NmoycWdraXJhMzJu"><i class="bi-instagram"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
